module.exports = {
	...
	spells: [
		...
		{ name: 'Heal', cost: 3, words: '', description: 'Recovers 3 hit points and cures injury on a single body part.', targeted: true, targetType: 'friend', effect: 'heal', param: 3 },
		{ name: 'Protection', cost: 3, words: 'UUS SANCT', description: 'Renders a player invincible for 30 seconds. ', targeted: true, targetType: 'friend', effect: 'counter', param: {message: 'is invincible', offMessage: 'is no longer invincible', time: 30}},
